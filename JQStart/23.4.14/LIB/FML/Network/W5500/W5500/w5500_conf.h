...
#define WIZ_SPIx_SCS_PIN                 GPIO_PIN_12						   	  /* 定义W5500的片选管脚          */
#define WIZ_SPIx_SCS_PORT                GPIOB									   	  /* GPIO端口                     */
#define WIZ_SPIx_SCS_CLK_ENABLE()        __HAL_RCC_GPIOB_CLK_ENABLE()	/* GPIO端口时钟                 */



#define WIZ_INT_PIN                      GPIO_PIN_8									  /* 定义W5500的INT管脚           */
#define WIZ_INT_PORT                     GPIOA									  	  /* GPIO端口                     */
#define WIZ_INT_CLK_ENABLE()             __HAL_RCC_GPIOA_CLK_ENABLE() /* GPIO端口时钟                 */

#define WIZ_RESET_PIN                   GPIO_PIN_1									  /* 定义W5500的INT管脚           */
#define WIZ_RESET_PORT                  GPIOA									  	    /* GPIO端口                     */
#define WIZ_RESET_CLK_ENABLE()           __HAL_RCC_GPIOA_CLK_ENABLE() /* GPIO端口时钟                 */
