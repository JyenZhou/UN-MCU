...
static 	void CD4051B_EN(uint8 boolean)
{
	if(boolean==1)
	{
		 HAL_GPIO_WritePin(CD4051B_EN_GPIO_Port,CD4051B_EN_Pin,GPIO_PIN_RESET);
	}else{
			  HAL_GPIO_WritePin(CD4051B_EN_GPIO_Port,CD4051B_EN_Pin,GPIO_PIN_SET);
	}
}
...
{CD4051B_EN(1);
			HAL_GPIO_WritePin(CD4051B_A_GPIO_Port,CD4051B_A_Pin,GPIO_PIN_RESET);
...
{CD4051B_EN(1);
	HAL_GPIO_WritePin(CD4051B_A_GPIO_Port,CD4051B_A_Pin,GPIO_PIN_RESET);
HAL_GPIO_WritePin(CD4051B_B_GPIO_Port,CD4051B_B_Pin,GPIO_PIN_SET);	
HAL_GPIO_WritePin(CD4051B_C_GPIO_Port,CD4051B_C_Pin,GPIO_PIN_RESET);
}
...
{CD4051B_EN(1);
		HAL_GPIO_WritePin(CD4051B_A_GPIO_Port,CD4051B_A_Pin,GPIO_PIN_RESET);
HAL_GPIO_WritePin(CD4051B_B_GPIO_Port,CD4051B_B_Pin,GPIO_PIN_RESET);
HAL_GPIO_WritePin(CD4051B_C_GPIO_Port,CD4051B_C_Pin,GPIO_PIN_SET);
...
void  CD4051B_init()
{
  ...
  未初始化CD4051B
    ...
    GPIO_InitStruct.Pin = CD4051B_EN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(CD4051B_EN_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CD4051B_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(CD4051B_A_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CD4051B_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(CD4051B_B_GPIO_Port, &GPIO_InitStruct);
	
	GPIO_InitStruct.Pin = CD4051B_C_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
